       ...
       <div class="flex-1 flex items-center justify-end gap-4" >
          <span class="font-medium">{{ post.totalLikes }} likes</span>
           <button @click="handleLike">
             <svg class="text-primary" width="22" height="20" viewBox="0 0 22 20" :fill="post.liked ? 'currentColor' : 'none'" xmlns="http://www.w3.org/2000/svg">
         ...
         <div class="relative top-10" v-if="dropdownIsVisible">
            <button @click="deletePostById(post.id)" class="text-red-500">
              delete
            </button>
         </div>
