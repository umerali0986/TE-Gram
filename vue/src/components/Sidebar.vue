        ...
        <div class="flex flex-col items-center gap-2">
          <router-link to='/app'>
            <button class="py-2 px-4 flex gap-3 w-[280px] rounded hover:bg-accent">
              <svg class="primary-color" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
              ...
              <button class="py-2 px-4 flex gap-3 w-[280px] rounded hover:bg-accent">
                <svg class="text-primary" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                      ...
                      stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M16 5H22" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M19 2V8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path
            ...
            <DialogContent class="max-w-fit">
              ...
              <div v-if="!isShowModal" class="flex flex-col items-center justify-between gap-2">
                <svg class="text-primary my-20" width="50" height="50" viewBox="0 0 24 24" fill="none"
                  ...
                  <path d="M16 5H22" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M19 2V8" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
                  <path
                      d="M9 11C10.1046 11 11 10.1046 11 9C11 7.89543 10.1046 7 9 7C7.89543 7 7 7.89543 7 9C7 10.1046 7.89543 11 9 11Z"
                      stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
                  <path
                  ...
                  <Accordion type="single" collapsible>
                    <AccordionItem value="item-1">
                      ...
                      <AccordionContent class="flex flex-col gap-2">
                        ...
                        <p class="text-sm">
                          The switch controls the visibility of your photos. When this feature is enabled, your photos are hidden from public view and can only be accessed by you.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
