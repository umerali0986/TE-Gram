  ...
  <div class="flex h-full w-full">
    <nav v-if="$store.state.isValidated"  class="w-80 h-[95vh] fixed left-0">
      <div class=" px-4">
        ...
        <button class="flex items-center w-full font-lg gap-4 hover:bg-foreground/5 px-4 py-2 rounded-md font-medium">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="flex px-4 flex-col w-full h-[74vh] items-start justify-end">
        <button class="flex items-center w-full font-lg gap-4 hover:bg-foreground/5 px-4 py-2 rounded-md font-medium">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
