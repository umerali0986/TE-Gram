      ...
      <div class="w-full flex h-full gap-10 flex-wrap lg:flex-nowrap">
        <div class="w-full h-full flex lg:flex-col flex-wrap gap-10">
          <div class="flex flex-col gap-4">
            ...
            <p class="">
              Did someone's post bring a smile to your face? Let them know by giving them a like!
            </p>
        ...
        <div class="w-full h-full flex flex-col gap-10">
          <div class="flex flex-col gap-4">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M38 42L24 34L10 42V10C10 8.93913 10.4214 7.92172 11.1716 7.17157C11.9217 6.42143 12.9391 6 14 6H34C35.0609 6 36.0783 6.42143 36.8284 7.17157C37.5786 7.92172 38 8.93913 38 10V42Z" fill="black" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          ...
          <div class="flex flex-col gap-4">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M38 6H10C7.79086 6 6 7.79086 6 10V38C6 40.2091 7.79086 42 10 42H38C40.2091 42 42 40.2091 42 38V10C42 7.79086 40.2091 6 38 6Z" fill="black" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M24 16V32" stroke="#FBFDFB" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M16 24H32" stroke="#FBFDFB" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
