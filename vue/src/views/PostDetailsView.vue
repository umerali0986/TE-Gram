          ...
          <div class="flex-1 w-full h-[33.5rem]  py-4 px-4 overflow-y-scroll gap-4 flex flex-col">
            ...
            <!-- <div class="w-full">
              <div class="flex gap-2">
                ...
                <div class="flex flex-col gap-0 justify-center">
                  <div class="flex-">
                    <p class=""><b class="font-semibold inline-flex leading-[1rem]">shadcn</b> Does that mean we’ll get lots more colour options in tables soon 🙏That would be incredible 🙂</p>
                  </div>
              ...
              <div class="flex w-full justify-between">
                <div class="flex gap-2 items-center">
                 <button @click="handleLike">
                  <svg class="text-primary" width="24" height="24" viewBox="0 0 24 24" :fill="post.liked ? 'currentColor' : 'none'" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="text-primary text-sm font-normal leading-tight">{{ post.totalLikes }}</span>
                </div>

                <div class="flex gap-2 items-center">
                  <svg class="text-primary" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="text-primary  text-sm font-normal leading-tight">{{ post.comments.length }}</span>
                </div>

                <div class="flex gap-2 items-center">
                  <button @click="handleBookmark">
                    <svg class="text-primary" width="16" height="20" viewBox="0 0 16 20" :fill="post.favorite ? 'currentColor' : 'none'"xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="text-primary  text-sm font-normal leading-tight">{{ post.totalFavorites }}</span>
                </div>
              </div>
